...
public class Pedido {
    ...
    public PedidoMemento criarBackup() {
        return new PedidoMemento(cliente, status, formaPagamento, tipoPedido, valorTotal, produtos, estoqueProdutos);
    }

    public void restaurarBackup(PedidoMemento memento) {
        this.cliente = memento.getCliente();
        this.status = memento.getStatus();
        this.formaPagamento = memento.getFormaPagamento();
        this.tipoPedido = memento.getTipoPedido();
        this.valorTotal = memento.getValorTotal();
        this.produtos = new ArrayList<>(memento.getProdutos());
        this.estoqueProdutos = memento.getEstoqueProdutos();
    }
